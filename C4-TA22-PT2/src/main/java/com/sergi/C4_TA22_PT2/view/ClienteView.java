...
public class ClienteView {
	...
	private void initialize() {
	    ...
	    btnEditCliente.setFont(new Font("Tahoma", Font.BOLD, 14));
	    btnEditCliente.setBounds(166, 362, 140, 40);
	    mainPanel.add(btnEditCliente);
	    
	    btnDeleteCliente = new JButton("Eliminar Cliente");
	    btnDeleteCliente.setFont(new Font("Tahoma", Font.BOLD, 14));
	    btnDeleteCliente.setBounds(10, 362, 146, 40);
	    mainPanel.add(btnDeleteCliente);
	    
	    btnAddNewCliente = new JButton("Añadir Cliente");
	    btnAddNewCliente.setFont(new Font("Tahoma", Font.BOLD, 14));
